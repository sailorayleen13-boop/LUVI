...
import { getAllMerchants } from "@/lib/marketplace/queries";
...
export default function SearchPage() {
  ...
  // search() is a fast, pure, synchronous read over in-memory mock data —
  // no need to stage it through state, just derive it each render.
  const results: SearchResults = trimmedQuery ? search(trimmedQuery) : EMPTY_RESULTS;
